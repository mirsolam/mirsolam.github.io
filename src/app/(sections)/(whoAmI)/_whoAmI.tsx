export default function WhoAmI() {
  return (
    <div
      ...
      data-name="section"
      data-index="1"
      data-continue-classname="short"
      data-xs-continue-classname="shorter"
      ...
      <div className="h-screen grid grid-row-1 items-center justify-items-center">
        <div className="grid row-start-1 items-center justify-items-center">
          <div className="flex items-start justify-items-end justify-end">
            <div
              id="accent_left_triangleup_whoami"
              className="accent-left-triangle-up mt-[-8.75rem] mr-[-1px] xs:mr-[0px]"
            />
          </div>
          <div className="flex items-start justify-items-start justify-start">
            <div
              id="accent_right_triangleup_whoami"
              className="accent-right-triangle-up mt-[-8.75rem] ml-[2px] mxs:ml-[0.5px] xs:ml-[0px]"
            />
          </div>
